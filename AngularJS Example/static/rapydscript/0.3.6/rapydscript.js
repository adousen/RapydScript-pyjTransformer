...
function OutputStream(options) {
    ...
    function spaced() {
        var _$rapyd$_Unpack, i, x;
        var _$rapyd$_Iter9 = _$rapyd$_Iterable(enumerate(arguments));
    ...
    function prologue(module_) {
        ...
        if (!options.omit_baselib) {
            var _$rapyd$_Iter10 = _$rapyd$_Iterable(module_.baselib);
            for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
                lib = _$rapyd$_Iter10[_$rapyd$_Index10];
                dump_baselib(lib);
            }
        }
    }
...
(function() {
    ...
    function write_imports(module_, output) {
        ...
        imports = [];
        var _$rapyd$_Iter11 = _$rapyd$_Iterable(Object.keys(module_.imports));
        for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
            import_id = _$rapyd$_Iter11[_$rapyd$_Index11];
        ...
        nonlocalvars = {};
        var _$rapyd$_Iter12 = _$rapyd$_Iterable(imports);
        for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
            module_ = _$rapyd$_Iter12[_$rapyd$_Index12];
            var _$rapyd$_Iter13 = _$rapyd$_Iterable(module_.nonlocalvars);
            for (var _$rapyd$_Index13 = 0; _$rapyd$_Index13 < _$rapyd$_Iter13.length; _$rapyd$_Index13++) {
                name = _$rapyd$_Iter13[_$rapyd$_Index13];
        ...
        var _$rapyd$_Iter14 = _$rapyd$_Iterable(imports);
        for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
            module_ = _$rapyd$_Iter14[_$rapyd$_Index14];
        ...
        var _$rapyd$_Iter15 = _$rapyd$_Iterable(imports);
        for (var _$rapyd$_Index15 = 0; _$rapyd$_Index15 < _$rapyd$_Iter15.length; _$rapyd$_Index15++) {
            module_ = _$rapyd$_Iter15[_$rapyd$_Index15];
            if (module_.module_id !== "__main__") {
    ...
    function display_complex_body(node, is_toplevel, output) {
        var offset, a, _$rapyd$_Unpack, i, arg, kw, dname, nargs;
        offset = 0;
        ...
        if (node instanceof AST_Scope) {
            if (node.argnames) {
                if (node.argnames.is_simple_func !== true) {
                    ...
                    var _$rapyd$_Iter16 = _$rapyd$_Iterable(enumerate(a));
                    for (var _$rapyd$_Index16 = 0; _$rapyd$_Index16 < _$rapyd$_Iter16.length; _$rapyd$_Index16++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter16[_$rapyd$_Index16];
                        i = _$rapyd$_Unpack[0];
                        ...
                        if (i >= offset) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(a.defaults, arg.name)) {
                                output.spaced("(arguments[" + (i - offset) + "]", "===", "undefined)", "?");
                                output.space();
                                output.with_parens(function() {
                            ...
                            output.print("arguments[" + (i - offset) + "]");
                            output.semicolon();
                            output.newline();
                        }
                    }
                    if (a.kwargs || a.has_defaults) {
                        ...
                        output.end_statement();
                        if (a.has_defaults) {
                            var _$rapyd$_Iter17 = _$rapyd$_Iterable(Object.keys(a.defaults));
                            for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
                                dname = _$rapyd$_Iter17[_$rapyd$_Index17];
                                output.indent();
    ...
    function declare_exports(module_id, exports, submodules, output) {
        ...
        seen = {};
        var _$rapyd$_Iter18 = _$rapyd$_Iterable(exports);
        ...
        var _$rapyd$_Iter19 = _$rapyd$_Iterable(submodules);
        for (var _$rapyd$_Index19 = 0; _$rapyd$_Index19 < _$rapyd$_Iter19.length; _$rapyd$_Index19++) {
            sub_module_id = _$rapyd$_Iter19[_$rapyd$_Index19];
    ...
    DEFPRINT(AST_Import, function(self, output) {
        ...
        if (self.argnames) {
            var _$rapyd$_Iter20 = _$rapyd$_Iterable(self.argnames);
            for (var _$rapyd$_Index20 = 0; _$rapyd$_Index20 < _$rapyd$_Iter20.length; _$rapyd$_Index20++) {
                argname = _$rapyd$_Iter20[_$rapyd$_Index20];
    ...
    AST_Lambda.DEFMETHOD("_do_print", function(output, nokeyword) {
        ...
        function internalsub() {
            ...
            output.with_parens(function() {
                if (!self.argnames || self.argnames.is_simple_func === true || self.argnames.is_simple_func === undefined) {
...
function tokenizer($TEXT, filename) {
    ...
    function read_line_comment() {
        var shebang = (arguments[0] === undefined) ? (false) : arguments[0];
        var _$rapyd$_kwargs_obj = arguments[arguments.length-1];
        if (typeof _$rapyd$_kwargs_obj !== "object" || _$rapyd$_kwargs_obj [symbolfor("_$rapyd$_kwargs_obj")] !== true) _$rapyd$_kwargs_obj = {};
...
function parse($TEXT, options) {
    ...
    if (options.classes) {
        var _$rapyd$_Iter1 = _$rapyd$_Iterable(options.classes);
        for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < _$rapyd$_Iter1.length; _$rapyd$_Index1++) {
            cname = _$rapyd$_Iter1[_$rapyd$_Index1];
        ...
        if (Array.isArray(body)) {
            for (name in body) {
                ...
                if (obj instanceof AST_Function || obj instanceof AST_Class) {
                    ...
                    var _$rapyd$_Iter2 = _$rapyd$_Iterable([ "body", "alternative" ]);
                    for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                        x = _$rapyd$_Iter2[_$rapyd$_Index2];
                        opt = obj[x];
                        if (opt) {
    ...
    function do_import(key) {
        ...
        function safe_read(base_path) {
            ...
            var _$rapyd$_Iter3 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
        ...
        modpath = key.replace(".", "/");
        var _$rapyd$_Iter4 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
        for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
            location = _$rapyd$_Iter4[_$rapyd$_Index4];
            if (location) {
    ...
    import_ = function(from_import) {
        ...
        if (from_import) {
            ...
            var _$rapyd$_Iter5 = _$rapyd$_Iterable(argnames);
            for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                argvar = _$rapyd$_Iter5[_$rapyd$_Index5];
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var _$rapyd$_Iter6 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var _$rapyd$_Iter7 = _$rapyd$_Iterable(enumerate(a));
